 ...
 */
@Slf4j
public class SenderRestResponseStreamObserver extends GenericResponseStreamObserver {

    private final SenderRestServiceGrpc.SenderRestServiceStub senderRestStub;

    public SenderRestResponseStreamObserver(ManagedChannel channel,
    ...
    protected void sendPong() {
        this.senderRestStub.sendRegulatoryRestMessage(this).onNext(createPongMessageRequest());
    }
