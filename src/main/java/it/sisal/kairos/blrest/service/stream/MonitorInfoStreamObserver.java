 ...
 */
@Slf4j
public class MonitorInfoStreamObserver extends GenericResponseStreamObserver {

    private final MonitorServiceGrpc.MonitorServiceStub monitorStub;

    public MonitorInfoStreamObserver(ManagedChannel channel, MonitorServiceGrpc.MonitorServiceStub monitorStub,
    ...
    protected void sendPong() {
        this.monitorStub.sendInfoMessage(this).onNext(createPongMessageRequest());
    }
